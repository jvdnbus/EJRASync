namespace EJRASync.Lib {
	public static partial class Constants {
		...
		public static readonly string EjraAuth = @"https://ejra-auth.enroy.space/authorize?client_id={0}&redirect_uri={1}&response_type=code";
		public static readonly string EjraAuthTokenExchange = "https://ejra-auth.enroy.space/token";
		...
		public static readonly string EjraApi = "https://ejra-api.enroy.space";
